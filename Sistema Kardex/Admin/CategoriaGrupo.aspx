<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Administrador.Master" AutoEventWireup="true" CodeBehind="CategoriaGrupo.aspx.cs" Inherits="Sistema_Kardex.Admin.CategoriaGrupo" %>
...
&nbsp;</td>
        <td>
            <asp:Label ID="lblIdF" runat="server" Text="Id de la Familia:"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:DropDownList ID="ListaBusqueda" runat="server">
        <asp:ListItem Value="IdCategoriaGrupo">Codigo</asp:ListItem>
        <asp:ListItem Value="IdCategoriaFamiliar">Codigo Familiar</asp:ListItem>
        <asp:ListItem Value="categoria_grupo">Nombre</asp:ListItem>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <asp:GridView ID="GridViewGrupo" runat="server" BackColor="White" BorderColor="#016D82" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" AllowPaging="True" OnPageIndexChanging="GridViewGrupo_PageIndexChanging" PageSize="6" OnSelectedIndexChanged="SelectIndexGrupo_SelectedIndexChanged" OnRowDeleting="GridViewGrupo_RowDeleting">
    <Columns>
