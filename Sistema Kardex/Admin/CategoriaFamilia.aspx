<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Administrador.Master" AutoEventWireup="true" CodeBehind="CategoriaFamilia.aspx.cs" Inherits="Sistema_Kardex.Admin.CategoriaFamilia" %>
...
&nbsp;<asp:TextBox ID="txtFecha" runat="server" ReadOnly="True"></asp:TextBox>
    ...
    <tr>
        <td class="auto-style3">&nbsp;<asp:Label ID="lblId" runat="server" Text="Id de la categoria:"></asp:Label>
            <asp:TextBox ID="txtId" runat="server" ReadOnly="True" Width="137px"></asp:TextBox>
        </td>
        <td>&nbsp;</td>
    </tr>
    <tr>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:DropDownList ID="ListaBusqueda" runat="server">
        <asp:ListItem Value="IdCategoriaFamiliar">Codigo</asp:ListItem>
        <asp:ListItem Value="categoria_familia">Nombre</asp:ListItem>
...
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <asp:GridView ID="GridViewFamilia" runat="server" BackColor="White" BorderColor="#016D82" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" AllowPaging="True" OnPageIndexChanging="GridViewFamilia_PageIndexChanging" PageSize="6" OnSelectedIndexChanged="SelectIndexFamilia_SelectedIndexChanged" OnRowDeleting="GridViewFamilia_RowDeleting">
    <Columns>
