<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Administrador.Master" AutoEventWireup="true" CodeBehind="SalaDeVentas.aspx.cs" Inherits="Sistema_Kardex.Admin.SalaDeVentas" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    ...
    <p>
        <asp:Label ID="lblNuevo" runat="server" Text="Ingresa el nombre de la nueva sala de ventas"></asp:Label>
    </p>
<table class="auto-style2">
    <tr>
        <td class="auto-style3">&nbsp;Nombre de la sala:<asp:TextBox ID="txtNombre" runat="server" ></asp:TextBox>
            &nbsp;&nbsp;
            &nbsp;</td>
    ...
    <tr>
        <td class="auto-style3">&nbsp; Direccion:<asp:TextBox ID="txtDireccion" runat="server" ></asp:TextBox>
        </td>
        <td class="auto-style3">&nbsp;
            <asp:Label ID="lblId" runat="server" Text="Id de la Sala:"></asp:Label>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" runat="server">
    ...
    <asp:DropDownList ID="ListaBusqueda" runat="server">
        <asp:ListItem Value="IdSala">Codigo</asp:ListItem>
...
&nbsp;&nbsp;<asp:Button ID="btnBuscar" runat="server" Text="Buscar" OnClick="btnBuscar_Click"  />
            ...
            &nbsp;
        <asp:Button ID="btnGenerar" runat="server" Text="Generar Reporte" Width="106px" OnClick="btnGenerar_Click" />
            </p>
</asp:Content>
<asp:Content ID="Content4" ContentPlaceHolderID="ContentPlaceHolder3" runat="server">
    <asp:GridView ID="GridViewSalaVenta" runat="server" BackColor="White" BorderColor="#016D82" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" AllowPaging="True" OnPageIndexChanging="GridViewSalaVenta_PageIndexChanging" PageSize="6" OnSelectedIndexChanged="SelectIndexSalaVenta_SelectedIndexChanged">
    <Columns>
