<%@ Page Title="" Language="C#" MasterPageFile="~/Admin/Administrador.Master" AutoEventWireup="true" CodeBehind="KardexGrupo.aspx.cs" Inherits="Sistema_Kardex.Admin.KardexGrupo" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <p>
    <h1>Kardex de Categoria Grupo</h1>
        </p>
...
<asp:Content ID="Content5" ContentPlaceHolderID="ContentPlaceHolder4" runat="server">
    ...
    <p>
         ...
         <asp:GridView ID="GridViewKardexGrupo" runat="server" BackColor="White" BorderColor="#016D82" BorderStyle="Double" BorderWidth="3px"  CellPadding="4" GridLines="Horizontal" Height="232px" Width="442px" CssClass="auto-style10">
        ...
        <asp:GridView ID="GridViewGrupo" runat="server" BackColor="White" BorderColor="#016D82" BorderStyle="Double" BorderWidth="3px" CellPadding="4" GridLines="Horizontal" AllowPaging="True" OnPageIndexChanging="GridViewGrupo_PageIndexChanging" PageSize="6" OnSelectedIndexChanged="SelectIndexGrupo_SelectedIndexChanged">
    <Columns>
